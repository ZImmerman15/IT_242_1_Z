...
namespace Manual1
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            string studentLastName = "Zimmerman";

            //this is how you add two strings together

            Console.WriteLine(studentFirstName + studentLastName);// if you check the output it is -- RussellMiller with no space

            Console.WriteLine(studentFirstName + " " + studentLastName);//this is why we learned $"{string interpolation}" see below
            Console.WriteLine(studentFirstName + " " + studentLastName);//this is why we learned $"{string interpolation}" see below

            Console.WriteLine($"The students name is {studentFirstName} {studentLastName}");
